...
const registry: ModelRegistryEntry[] = [
  ...
  // ─── DotPoint (Russian gateway) ───
  { id: 'dotpoint/deepseek-chat', displayName: 'DeepSeek-V3 (DotPoint)', provider: 'dotpoint', creator: 'DeepSeek AI via DotPoint', releaseDate: '2024-12', parameterCount: '671B (MoE)', strengths: ['coding', 'math', 'reasoning', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/deepseek-reasoner', displayName: 'DeepSeek-R1 (DotPoint)', provider: 'dotpoint', creator: 'DeepSeek AI via DotPoint', releaseDate: '2025-01', parameterCount: '671B (MoE)', strengths: ['deep-reasoning', 'math', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/deepseek-coder', displayName: 'DeepSeek Coder (DotPoint)', provider: 'dotpoint', creator: 'DeepSeek AI via DotPoint', releaseDate: '2024-06', parameterCount: 'unknown', strengths: ['coding', 'code-generation'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gpt-4.1', displayName: 'GPT-4.1 (DotPoint)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2025-04', parameterCount: 'unknown', strengths: ['reasoning', 'coding', 'long-context'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gpt-4.1-mini', displayName: 'GPT-4.1 Mini (DotPoint)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2025-04', parameterCount: 'unknown', strengths: ['speed', 'efficiency', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gpt-4.1-nano', displayName: 'GPT-4.1 Nano (DotPoint)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2025-04', parameterCount: 'unknown', strengths: ['speed', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gpt-4o-mini', displayName: 'GPT-4o Mini (DotPoint)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2024-07', parameterCount: '~8B (est.)', strengths: ['speed', 'efficiency', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gemini/gemini-2.5-flash', displayName: 'Gemini 2.5 Flash (DotPoint)', provider: 'dotpoint', creator: 'Google via DotPoint', releaseDate: '2025-03', parameterCount: 'unknown', strengths: ['speed', 'multimodal', 'reasoning'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gemini/gemini-2.5-flash-lite', displayName: 'Gemini 2.5 Flash Lite (DotPoint)', provider: 'dotpoint', creator: 'Google via DotPoint', releaseDate: '2025-04', parameterCount: 'unknown', strengths: ['speed', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gemini/gemini-flash-latest', displayName: 'Gemini Flash Latest (DotPoint)', provider: 'dotpoint', creator: 'Google via DotPoint', releaseDate: '2025-03', parameterCount: 'unknown', strengths: ['speed', 'multimodal'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/gemini/gemini-flash-lite-latest', displayName: 'Gemini Flash Lite Latest (DotPoint)', provider: 'dotpoint', creator: 'Google via DotPoint', releaseDate: '2025-03', parameterCount: 'unknown', strengths: ['speed', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/mistral-large-latest', displayName: 'Mistral Large (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-11', parameterCount: '123B', strengths: ['reasoning', 'coding', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/mistral-medium-latest', displayName: 'Mistral Medium (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-12', parameterCount: 'unknown', strengths: ['reasoning', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/mistral-medium', displayName: 'Mistral Medium v1 (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-06', parameterCount: 'unknown', strengths: ['reasoning', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/mistral-small', displayName: 'Mistral Small (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-09', parameterCount: '22B', strengths: ['efficiency', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/mistral-tiny', displayName: 'Mistral Tiny (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-03', parameterCount: '7B', strengths: ['speed', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/codestral-2405', displayName: 'Codestral 24.05 (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2024-05', parameterCount: '22B', strengths: ['coding', 'code-generation'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/codestral-2508', displayName: 'Codestral 25.08 (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2025-08', parameterCount: 'unknown', strengths: ['coding', 'code-generation'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/codestral-latest', displayName: 'Codestral Latest (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2025-08', parameterCount: 'unknown', strengths: ['coding', 'code-generation'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/mistral/devstral-2512', displayName: 'Devstral (DotPoint)', provider: 'dotpoint', creator: 'Mistral AI via DotPoint', releaseDate: '2025-12', parameterCount: 'unknown', strengths: ['coding', 'reasoning'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/llama-3.3-70b-versatile', displayName: 'Llama 3.3 70B (DotPoint/Groq)', provider: 'dotpoint', creator: 'Meta AI via DotPoint', releaseDate: '2024-12', parameterCount: '70B', strengths: ['coding', 'reasoning', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/llama-3.1-8b-instant', displayName: 'Llama 3.1 8B (DotPoint/Groq)', provider: 'dotpoint', creator: 'Meta AI via DotPoint', releaseDate: '2024-07', parameterCount: '8B', strengths: ['speed', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/meta-llama/llama-4-scout-17b-16e-instruct', displayName: 'Llama 4 Scout (DotPoint/Groq)', provider: 'dotpoint', creator: 'Meta AI via DotPoint', releaseDate: '2025-04', parameterCount: '17B (16E)', strengths: ['reasoning', 'efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/meta-llama/llama-4-maverick-17b-128e-instruct', displayName: 'Llama 4 Maverick (DotPoint/Groq)', provider: 'dotpoint', creator: 'Meta AI via DotPoint', releaseDate: '2025-04', parameterCount: '17B (128E)', strengths: ['reasoning', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/gemma-7b-it', displayName: 'Gemma 7B (DotPoint/Groq)', provider: 'dotpoint', creator: 'Google via DotPoint', releaseDate: '2024-02', parameterCount: '7B', strengths: ['efficiency'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/qwen/qwen3-32b', displayName: 'Qwen3 32B (DotPoint/Groq)', provider: 'dotpoint', creator: 'Alibaba via DotPoint', releaseDate: '2025-04', parameterCount: '32B', strengths: ['reasoning', 'multilingual', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/moonshotai/kimi-k2-instruct-0905', displayName: 'Kimi K2 (DotPoint/Groq)', provider: 'dotpoint', creator: 'Moonshot AI via DotPoint', releaseDate: '2025-09', parameterCount: 'unknown', strengths: ['reasoning', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/openai/gpt-oss-20b', displayName: 'GPT-OSS 20B (DotPoint/Groq)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2025-06', parameterCount: '20B', strengths: ['efficiency', 'coding'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/openai/gpt-oss-120b', displayName: 'GPT-OSS 120B (DotPoint/Groq)', provider: 'dotpoint', creator: 'OpenAI via DotPoint', releaseDate: '2025-06', parameterCount: '120B', strengths: ['reasoning', 'coding', 'multilingual'], pricing: { input: '≈₽', output: '≈₽' } },
  { id: 'dotpoint/groq/meta-llama/llama-guard-4-12b', displayName: 'Llama Guard 4 (DotPoint/Groq)', provider: 'dotpoint', creator: 'Meta AI via DotPoint', releaseDate: '2025-04', parameterCount: '12B', strengths: ['analysis'], pricing: { input: '≈₽', output: '≈₽' } },
];

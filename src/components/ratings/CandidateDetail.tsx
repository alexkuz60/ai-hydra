...
import { Brain, Cpu, Calendar, Scale, DollarSign, Check, X, Crown, KeyRound, Globe } from 'lucide-react';
                  ...
                  <div className="min-w-0 flex-1 space-y-2">
                    ...
                    {registry && (
                      <div className="flex gap-4">
                        ...
                        {/* Strengths badges column */}
                        {registry.strengths && registry.strengths.length > 0 && (
                          <div className="flex flex-col flex-wrap gap-1.5 max-h-32">

...
const translations: Translations = {
  ...
  'memory.storage.bucketKnowledgeFiles': { ru: 'Профильные знания', en: 'Profile Knowledge' },
  ...
  'memory.storage.fromHydrapedia': { ru: 'Из Гидрапедии', en: 'From Hydrapedia' },
  'memory.storage.systemKnowledge': { ru: 'Системные', en: 'System' },
  'memory.storage.knowledgePrompts': { ru: 'Промпты', en: 'Prompts' },
  'memory.storage.knowledgeCompetencies': { ru: 'Компетенции', en: 'Competencies' },
  'memory.storage.knowledgeDocs': { ru: 'Документация', en: 'Documentation' },
  ...
  'hydrapedia.sections.architecturalContracts': { ru: 'Архитектурные контракты', en: 'Architectural Contracts' },
...
'tasks.title': { ru: 'Стратегические планы решений задач (СПРЗ)', en: 'Strategic Problem Solving Plans (SPSP)' },
  ...
  'tasks.configSaved': { ru: 'Настройки сохранены', en: 'Settings saved' },
   ...
   'plans.newPlaceholder': { ru: 'Название стратегического плана...', en: 'Strategic plan name...' },
    ...
    'plans.goalFormulation': { ru: 'Концепция и цель проекта', en: 'Project concept & goal' },
    'plans.goalPlaceholder': { ru: 'Опишите визионерскую концепцию и стратегическую цель плана...', en: 'Describe the visionary concept and strategic goal of the plan...' },
    'plans.save': { ru: 'Сохранить концепцию', en: 'Save concept' },
   ...
   'plans.subtask': { ru: 'Подзадача', en: 'Subtask' },
    'plans.editTitle': { ru: 'Редактировать название', en: 'Edit title' },
    'plans.patentSearch': { ru: 'Патентный поиск', en: 'Patent search' },
     'plans.standaloneTasks': { ru: 'Отдельные задачи', en: 'Standalone tasks' },
     'plans.concept': { ru: 'Концепция плана', en: 'Plan concept' },

...
Патентовед — штатная роль, анализирующая решения пользователя на патентоспособность. Работает в двух режимах:
...
- [ ] Определение роли в `roles.ts` с категорией `legal`
- [ ] Добавление группы «Юридический отдел» в UI StaffRoles
- [ ] Системный промпт (два режима)
- [ ] Критерии собеседования
